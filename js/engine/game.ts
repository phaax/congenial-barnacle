...
import type { Player, PlayerConfig, World, Location, Layout, Combat, Quest, Message, DialogSession, Screen } from '../types';
import { InputManager, KEY } from './input';
import { RNG } from './rng';
import { STATE, C, COLS, ROWS, MSG_ROWS, VIEW_ROWS, MAIN_COLS } from '../data/constants';
import { MusicManager } from '../audio/musicManager';
import { generateWorld, updateFog, getBiomeAt, getLocationAt, getTownLayout, getDungeonLayout } from '../world/worldgen';
import { generateQuests, onMonsterKilled, onItemPickedUp, onLocationVisited, checkGoalProgress } from '../systems/quest';
import { getRace } from '../data/races';
import { getBackground } from '../data/backgrounds';
import { getSkill } from '../data/skills';
import { getItem } from '../data/items';
import { spawnEncounter, spawnMonster, initCombat, applyRewards, xpToLevel } from '../systems/combat';
import { startDialog } from '../systems/dialog';
...
export class Game {
  ...
  private _jukeboxPrevState: string | null;
  private _jukeboxPrevData: unknown;
  private _settingsPrevState: string | null;
  private _settingsPrevData: unknown;
